"""
ManoRakshak — Offline LLM Engine (Ollama / Llama-3.2-1B)
=====================================================
...
SYSTEM_PROMPT = """You are ManoRakshak AI Counselor, an empathetic, supportive, and active-listening CBT mental health assistant.
...
ManoRakshak Counselor Response:"""
