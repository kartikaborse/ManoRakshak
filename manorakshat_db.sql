...
🌴 *Tip: Sometimes a quiet distraction helps. Try escaping to the [Cozy Island Garden](/games/manorakshat_cozy_island_garden) activity.*', 0, '2026-06-18T13:52:35');
...
🌴 *Tip: Sometimes a quiet distraction helps. Try escaping to the [Cozy Island Garden](/games/manorakshat_cozy_island_garden) activity.*', 0, '2026-06-18T14:42:45');
...
🌴 *Tip: Sometimes a quiet distraction helps. Try escaping to the [Cozy Island Garden](/games/manorakshat_cozy_island_garden) activity.*', 0, '2026-06-18T14:43:06');
...
🌴 *Tip: Sometimes a quiet distraction helps. Try escaping to the [Cozy Island Garden](/games/manorakshat_cozy_island_garden) activity.*', 0, '2026-06-18T15:55:08');
...
INSERT INTO `therapists` (`id`, `name`, `title`, `specialization`, `experience`, `rating`, `fees`, `location`, `availability`, `contact_email`, `contact_phone`, `photo_url`, `bio`, `created_at`, `user_id`) VALUES (1, 'Dr. Aarav Mehta', 'Consultant Psychiatrist', 'Depression, Bipolar Disorder, Mood Swings, Medication Management', 12, 4.8, 1500, 'Mumbai (Online / In-Person)', 'Mon-Wed, 10:00 AM - 4:00 PM', 'aarav.mehta@manorakshat.com', '+91 98765 43210', '/static/avatars/therapist_aarav.png', 'Dr. Aarav Mehta is a highly experienced psychiatrist specializing in mood disorders and medication-assisted therapy, focusing on a holistic recovery path.', '2026-06-17T01:00:23', NULL);
INSERT INTO `therapists` (`id`, `name`, `title`, `specialization`, `experience`, `rating`, `fees`, `location`, `availability`, `contact_email`, `contact_phone`, `photo_url`, `bio`, `created_at`, `user_id`) VALUES (2, 'Ms. Ananya Sen', 'Clinical Psychologist & CBT Specialist', 'Anxiety, OCD, Stress Management, Cognitive Behavioral Therapy (CBT)', 8, 4.9, 1200, 'Delhi (Online)', 'Tue-Fri, 9:00 AM - 5:00 PM', 'ananya.sen@manorakshat.com', '+91 98765 43211', '/static/avatars/therapist_ananya.png', 'Ananya Sen specializes in CBT and mindfulness-based therapies to help clients navigate anxiety, panic attacks, and daily stress management.', '2026-06-17T01:00:23', NULL);
INSERT INTO `therapists` (`id`, `name`, `title`, `specialization`, `experience`, `rating`, `fees`, `location`, `availability`, `contact_email`, `contact_phone`, `photo_url`, `bio`, `created_at`, `user_id`) VALUES (3, 'Dr. Rohan Deshmukh', 'Child & Adolescent Psychiatrist', 'ADHD, Teen Anxiety, Family Counseling, Behavioral Issues', 15, 4.7, 1800, 'Pune (Online / In-Person)', 'Mon-Thu, 2:00 PM - 7:00 PM', 'rohan.deshmukh@manorakshat.com', '+91 98765 43212', '/static/avatars/therapist_rohan.png', 'Dr. Rohan has extensive experience working with children, teenagers, and families to address developmental, behavioral, and academic challenges.', '2026-06-17T01:00:23', NULL);
INSERT INTO `therapists` (`id`, `name`, `title`, `specialization`, `experience`, `rating`, `fees`, `location`, `availability`, `contact_email`, `contact_phone`, `photo_url`, `bio`, `created_at`, `user_id`) VALUES (4, 'Ms. Meera Nair', 'Trauma-Informed Counseling Psychologist', 'Trauma Recovery, Grief Counseling, Self-Esteem, Relationship Advice', 6, 4.9, 1000, 'Bengaluru (Online)', 'Wed-Sat, 11:00 AM - 6:00 PM', 'meera.nair@manorakshat.com', '+91 98765 43213', '/static/avatars/therapist_meera.png', 'Meera Nair is dedicated to providing a safe, non-judgmental space for clients recovering from trauma, grief, or navigating difficult relationship transitions.', '2026-06-17T01:00:23', NULL);
INSERT INTO `therapists` (`id`, `name`, `title`, `specialization`, `experience`, `rating`, `fees`, `location`, `availability`, `contact_email`, `contact_phone`, `photo_url`, `bio`, `created_at`, `user_id`) VALUES (5, 'Dr. Shalini Kapoor', 'Neuropsychiatrist', 'Sleep Disorders, ADHD, Chronic Stress, Cognitive Rehabilitation', 10, 4.8, 1600, 'Hyderabad (Online / In-Person)', 'Mon-Fri, 10:00 AM - 1:00 PM', 'shalini.kapoor@manorakshat.com', '+91 98765 43214', '/static/avatars/therapist_shalini.png', 'Dr. Shalini Kapoor focuses on the intersection of neurological health and psychiatric well-being, helping clients with sleep, attention, and chronic stress issues.', '2026-06-17T01:00:23', NULL);
