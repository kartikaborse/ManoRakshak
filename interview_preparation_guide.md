...
* **Answer:**
  ...
  4. The request triggers [save_diary_entry()](file:///c:/xampp/htdocs/mindcare_new/backend/db.py#L206) which connects to the MySQL connection pool ([manokart_db](file:///c:/xampp/htdocs/mindcare_new/backend/db.py#L20)).
...
### Q14. The ML model currently loads from a static Pickle file (`manokart_model.pkl`) into RAM on server start. How would you redesign this for scalability?
* **Answer:**
